...
Completed milestone logs, newest first. Moved out of TODO.md in M11 so that
file holds only the ACTIVE milestone — see ROADMAP.md for what comes next and
CLAUDE.md for the architecture these milestones built.
